  ...
  try {
    ...
    for (const item of items) {
      ...
      await pool.request()
        ...
        .input('producto',        sql.NVarChar(sql.MAX), item.producto || '')
        .input('destino',         sql.NVarChar(sql.MAX), item.destino || null)
        .input('foto_url',        sql.NVarChar(sql.MAX), item.foto_url || null)
        .input('link',            sql.NVarChar(sql.MAX), item.link || null)
