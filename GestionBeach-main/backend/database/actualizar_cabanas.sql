-- ============================================
-- ACTUALIZAR INFORMACIÓN DE CABAÑAS
-- Información detallada y corregida
-- ============================================
...
-- ============================================
-- AGREGAR COLUMNA AMENIDADES SI NO EXISTE
-- ============================================
IF NOT EXISTS (
    SELECT 1
    FROM sys.columns
...
PRINT '✅ Información de cabañas actualizada correctamente';
PRINT '📋 Resumen:';
PRINT '  - Cabaña 1: 10 personas, 4 dormitorios, 2 baños, Terraza Propia';
PRINT '  - Cabañas 2-4: 4 personas, 3 dormitorios, 2 baños, Quincho';
PRINT '  - Cabaña 3: Frente a terraza grande';
PRINT '  - Cabaña 5: 6 personas, 2 dormitorios, 1 baño, con literas';
PRINT '  - Cabaña 6: 7 personas, Rústica, Estacionamiento propio';
PRINT '  - Cabañas 7-8: 7 personas, 3 dormitorios, En altura';
PRINT '  - Departamentos A y B: Solo parejas, Jacuzzi premium';
