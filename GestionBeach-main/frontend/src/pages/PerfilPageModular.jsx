// frontend/src/pages/PerfilPageModular.jsx - VERSIÓN CON PERMISOS POR MÓDULO
...
export default function PerfilPageModular() {
              ...
              <Grid item xs={12}>
                <Paper sx={{ p: 2 }} variant="outlined">
                  ...
                  <Alert severity="info" sx={{ mb: 2 }}>
                    ...
                    <br/>2. Dentro del módulo, elige las sucursales permitidas
                    <br/>3. Configura permisos (Leer/Escribir/Exportar) para cada sucursal
                  </Alert>
                            ...
                            <AccordionDetails>
                              <Box sx={{ pl: 6 }}>
                                <Typography variant="subtitle2" gutterBottom color="primary">
                                  Sucursales Permitidas en este Módulo:
                                </Typography>
